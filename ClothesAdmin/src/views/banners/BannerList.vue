...
.banner-preview {
  position:relative; display:inline-block; border:1px solid #e8e5e0; border-radius:4px; overflow:hidden;
}
.banner-preview-img { display:block; max-width:100%; max-height:120px; object-fit:contain; background:#f5f3f0; }
.banner-preview-del {
  position:absolute; top:4px; right:4px; width:20px; height:20px; border:none; border-radius:50%;
  background:rgba(0,0,0,0.4); color:#fff; font-size:11px; cursor:pointer; display:flex; align-items:center; justify-content:center;
}
.banner-preview-del:hover { background:rgba(196,92,74,0.8); }

.upload-zone-sm {
  border:1.5px dashed #e8e5e0; border-radius:6px; padding:16px; text-align:center;
  cursor:pointer; transition:all 0.2s; color:#999; font-size:13px; background:#faf9f7;
}
.upload-zone-sm:hover { border-color:#c45c4a; color:#c45c4a; background:#fdf5f3; }
</style>
