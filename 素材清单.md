...
> **格式**：jpg（轮播图 1920×600，商品图 800×1000）
> **路径**：放 `ClothesUser/public/assets/products/` 和 `banners/` 下
> **原则**：同型号不同规格（容量/颜色）共用同一张图
...
> **占位图已生成**：目前 `assets/products/` 下已有同名的 `.svg` 占位图，找好真实图片后替换即可
> **图片大小**：商品图 800×1000px，轮播图 1920×600px
